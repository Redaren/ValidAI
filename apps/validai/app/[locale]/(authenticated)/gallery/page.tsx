...
import { CreateGallerySheet } from "@/components/galleries/create-gallery-sheet"
import { useUserGalleries } from "@/app/queries/galleries"
...
export default function GalleriesPage() {
  ...
  const { data, isLoading, error } = useUserGalleries(false, {
  ...
  return (
    <div className="space-y-6">
      ...
      <GalleriesTable
        ...
        isLoading={isLoading}
        isEmpty={!isLoading && (!data?.galleries || data.galleries.length === 0)}
